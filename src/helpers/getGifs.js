export const getGifs = async(category) => {
    // Estamos creando la forma de comunicarnos con una API
        const url = `https://api.giphy.com/v1/gifs/search?api_key=adKTgTwCrqhZK1qfQFuuDtYdOvs00TlD&q=${category}&limit=1`;

        // estamos escogiendo la categoria con las llaves y estamos limitando la cantidad de elementos a 20
